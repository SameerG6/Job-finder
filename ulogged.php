...
if (isset($_SESSION['uid'])) {
    ...
    $user_query = "SELECT field, exp FROM udet WHERE uid = '$uid'";
    $user_result = $conn->query($user_query);
    $user_row = $user_result->fetch_assoc();
    $user_field = $user_row['field'];
    $user_exp = $user_row['exp'];

    $sql = "SELECT * FROM jobs WHERE jfield = '$user_field' AND jexp <= '$user_exp'";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "No jobs available matching your current field and experience.";
    }
